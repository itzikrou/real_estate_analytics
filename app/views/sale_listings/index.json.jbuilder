json.array!(@sale_listings) do |listing|
  json.extract! listing, :id, :mls_id, :status, :list_date, :sold_date, :last_fetched_status,
  ...
  json.url sale_listings_url(listing, format: :json)
